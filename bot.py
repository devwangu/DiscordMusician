...
class MusicCog(commands.Cog):
    ...
    @commands.command(name='play', help='เล่นเพลง (YouTube, SoundCloud, Twitch)')
...
def run_bot(token):
    ...
    # Reset internal state to avoid bleeding between sessions
    music_queues = {}
    current_song = {}
    disconnect_timers = {}
    ...
    # สร้าง instance ของ bot ใหม่เสมอเมื่อกด Start
    intents = discord.Intents.default()
    intents.message_content = True
    bot = commands.Bot(
        command_prefix=commands.when_mentioned_or("!"),
